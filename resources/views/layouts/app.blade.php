...
<head>
 ...
 .card:hover {
   ...
   box-shadow: 0 12px 20px white; /* Efek bayangan saat dihover */
 }
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        @else
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('destinasi.index') }}">Destination</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pengunjung.index') }}">Visitors</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('reservasi.index') }}">Reservation</a>
                        </li>
                        <li class="nav-item">
